...
export default function NormalScreen() {
    ...
    const [config, setConfig] = useState({
        rpcUrl: `https://api.stackup.sh/v1/node/887ed5a7ba4146dc3c53aa61d8e978ba3389337c69b8d435a19571e98eeee491`,
        signingKey: privateKey,
        entryPoint: "0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789",
        simpleAccountFactory: "0x9406Cc6185a346906296840746125a0E44976454",
        paymaster: {
            rpcUrl: "https://api.stackup.sh/v1/paymaster/887ed5a7ba4146dc3c53aa61d8e978ba3389337c69b8d435a19571e98eeee491",
            context: {},
        },
    })
